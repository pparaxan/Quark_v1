...
fn new_empty_package(msi_path: &Path) -> super::Result<Package> {
...
fn collect_resource_info(settings: &Settings) -> super::Result<Vec<ResourceInfo>> {
...
) -> super::Result<Vec<DirectoryInfo>> {
...
fn create_feature_table(package: &mut Package, settings: &Settings) -> super::Result<()> {
    package.create_table(
        "Feature",
        vec![
...
fn create_media_table(package: &mut Package, cabinets: &[CabinetInfo]) -> super::Result<()> {
    package.create_table(
        "Media",
        vec![
...
// executable).
fn create_file_table(package: &mut Package, cabinets: &[CabinetInfo]) -> super::Result<()> {
    package.create_table(
        "File",
        vec![
...
fn create_dialog_table(package: &mut Package, _cabinets: &[CabinetInfo]) -> super::Result<()> {
    package.create_table(
        "Dialog",
        vec![
...
fn create_control_table(package: &mut Package, _cabinets: &[CabinetInfo]) -> super::Result<()> {
    package.create_table(
        "Control",
        vec![
...
fn create_text_style_table(package: &mut Package, _cabinets: &[CabinetInfo]) -> super::Result<()> {
    package.create_table(
        "TextStyle",
        vec![
...
fn create_app_icon<W: Write>(writer: &mut W, settings: &Settings) -> super::Result<()> {
    // Prefer ICO files.
