function createDataURL(data, format) {
    // Had to use AI to display the song's image from it's metadata, dude i never knew taking a image from a file and displaying it was that hard.
